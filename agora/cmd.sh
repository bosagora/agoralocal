...
if [ "$1" = "init" ]; then
    ...
    docker run -it --rm \
      ...
      --mnemonic="board fire prize defy limb arm diet fee usage settle rigid sunny duty squirrel cheap history session same tilt candy loan culture pretty anchor"
